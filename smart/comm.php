                ...
                <td>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <br><br>
                            <h1>Our Community</h1><br><br>
                            <table style="margin-right:20px;">
                                <tr>
                                    <td align="left"><img src="imgs/comms.webp" width="1000px"></td>
                                </tr>
                             </table>   
                            <p style="padding-top:10px;">
                                    <span style="font-size:20px;">Staying</span> Together, Exploring the world together.
                                </p><br><br>
